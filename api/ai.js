...
- UNSAVEABLE PRODUCTS: when the marketing/funnel photos and the factory QC photos show a fundamentally DIFFERENT product (different construction, different garment type — not just styling), edits will not save it. Recommend killing the product, especially when the refund rate is high. Do not propose cosmetic fixes for a product that cannot be saved.
